...
<body>
  ...
  $table_acteurs = $bdd -> query('SELECT id_acteur, acteur, description_courte FROM acteurs');
  $acteur = $table_acteurs -> fetch();
...
} // fin de if( isset($_SESSION['nom']) && isset($_SESSION['prenom']) )
